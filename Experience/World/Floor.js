...
export default class Floor {
  ...
  setCircles() {
    ...
    const material1 = new THREE.MeshStandardMaterial({ color: 0x3b3b3b });
    const material2 = new THREE.MeshStandardMaterial({ color: 0x757575 });
    const material3 = new THREE.MeshStandardMaterial({ color: 0x2e2929 });
